...
define('ENCRYPTION_KEY', 'digantiiniajayakalogitu');

// OAuth consumer and secret keys. Available from http://twitter.com/oauth_clients
define('OAUTH_CONSUMER_KEY', 'LmHkBmefJqybLHFodjxwA');
define('OAUTH_CONSUMER_SECRET', '5QLXVuYsT1M8A9iOZAJX4WRLEMeydPCyTkrioXwUHTA');
